...
const BenefitsSection = () => {
  return (
    <section id="beneficios" className="relative py-12 md:py-16 lg:py-18 overflow-hidden">
      {/* Background Premium */}
        ...
        <div className="mb-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {benefits.filter(benefit => benefit.priority === "high").map((benefit, index) => (
              ...
              >
                <div className="premium-card p-6 h-full border-primary/20 hover:border-primary/40 transition-all duration-500">
                  {/* Icon Premium */}
